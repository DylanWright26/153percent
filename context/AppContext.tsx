...
if (aComplete !== bComplete) {
  return Number(aComplete) - Number(bComplete);
        ...
        if (
          a.required_for_streak !==
          b.required_for_streak
        ) {

          return a.required_for_streak
            ? -1
            : 1;
  ...
  async function updateMissionProgress(
    ...
    // Mission completed for first time
    if (
      !wasComplete &&
      isComplete
    ) {
